          ...
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text__para">
                  ...
                  Fugiat optio accusantium voluptatibus. Necessitatibus fuga id
                  quos aliquam ratione adipisci voluptas amet, aut voluptatum
                  doloremque cum officia, harum labore saepe! Cumque? Unde quas
                  sequi, maiores voluptatibus earum alias esse sit.
                </p>
            ...
            <div className="flex gap-[30px] justify-end">
              ...
              <div className="mt-[30px]">
                ...
                />
                <img src={heroImg03} alt="heroImg02" className="w-full" />
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
              ...
              <div className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
                <div className="flex items-center justify-between">
                  ...
                  <span className="w-5 h-5 lg:w-[34px] lg:h-[34px] flex items-center justify-center bg-yellowColor rounded py-1 px-[6px] lg:px-[6px] lg:py-3 lg:px-[9px]">
